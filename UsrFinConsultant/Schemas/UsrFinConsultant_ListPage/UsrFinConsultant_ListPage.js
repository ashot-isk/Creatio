define("UsrFinConsultant_ListPage", /**SCHEMA_DEPS*/[]/**SCHEMA_DEPS*/, function/**SCHEMA_ARGS*/()/**SCHEMA_ARGS*/ {
	return {
		viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
			...
			},
			{
				...
				"values": {
					...
					"rootSchemaName": "UsrFinConsultant",
					"layoutConfig": {
						"width": 328.125
					},
					"classes": [
		...
		modelConfig: /**SCHEMA_MODEL_CONFIG*/{
			"dataSources": {
				"PDS": {
					...
					"config": {
						"entitySchemaName": "UsrFinConsultant"
					},
					"scope": "viewElement"
				}
			}
